    ...
    <style>
        * {
        ...
        .blog-card-bg {
            ...
            filter: saturate(100%) contrast(100%) brightness(100%); /* FULL COLOR */
        ...
        .blog-card:hover .blog-card-bg {
            ...
            filter: saturate(0%) contrast(67%) brightness(100%); /* B&W on hover */
        }
...
<body>
    ...
    <script>
        ...
        menuToggle.addEventListener('click', (e) => {
            ...
            console.log('Menu toggled:', menuContainer.classList.contains('active'));
        });
        ...
        async function loadBlogPosts() {
            try {
                ...
                console.log(`✅ Rendered ${posts.length} cards with COLOR images`);
            } catch (error) {
