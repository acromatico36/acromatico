-- Demo data for Acromatico Education Platform
-- Creates sample students and enrollments for testing

-- Get the user ID for italo@acromatico.com (parent account)
-- First, let's add some students

-- Student 1: Emma Johnson (Age 10)
INSERT INTO students (first_name, last_name, date_of_birth, grade, parent_id)
SELECT 'Emma', 'Johnson', '2016-03-15', '5th Grade', id FROM users WHERE email = 'italo@acromatico.com';

-- Student 2: Lucas Martinez (Age 13)
INSERT INTO students (first_name, last_name, date_of_birth, grade, parent_id)
SELECT 'Lucas', 'Martinez', '2013-08-22', '8th Grade', id FROM users WHERE email = 'italo@acromatico.com';

-- Student 3: Sophia Chen (Age 7)
INSERT INTO students (first_name, last_name, date_of_birth, grade, parent_id)
SELECT 'Sophia', 'Chen', '2019-01-10', '2nd Grade', id FROM users WHERE email = 'italo@acromatico.com';
...
-- Lucas gets "Quick Learner" and "Dedicated Student"
INSERT INTO student_achievements (student_id, achievement_id, awarded_by)
SELECT s.id, a.id, u.id
FROM students s, achievements a, users u
