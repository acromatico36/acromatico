// Shared Header & Mobile Menu Component - Single Source of Truth
// This header/menu is used site-wide: homepage, blog posts, all pages
...
<style>
  ...
  .menu-toggle:hover span {
    background: ${ACROMATICO_COLOR} !important;
  }
