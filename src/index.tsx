...
app.get('/invoices', (c) => {
  return c.render(
    <div class="min-h-screen bg-black text-white">
      ...
      {/* JavaScript */}
      <script dangerouslySetInnerHTML={{__html: `
        // Program benefits (Step Up PEP compliant descriptions)
        const programBenefits = {
          'academy-1-monthly': 'Part-time photography tutoring services provided by credentialed instructors. Educational instruction includes composition, lighting techniques, camera operation, and creative skill development. Program includes 8 individual tutoring sessions per month (30 minutes each), supplemental recorded instruction materials, digital curriculum resources, and portfolio development guidance for ages 7-14.',
          'academy-1-annual': 'Full-year part-time photography tutoring services provided by credentialed instructors. Educational instruction includes composition, lighting techniques, camera operation, and creative skill development. Program includes 8 individual tutoring sessions per month (30 minutes each), supplemental recorded instruction materials, digital curriculum resources, December enrichment workshops, and portfolio development guidance for ages 7-14.',
          'academy-2-monthly': 'Part-time photography tutoring services provided by credentialed instructors. Educational instruction includes composition, lighting techniques, camera operation, and creative skill development. Program includes 8 individual tutoring sessions per month (30 minutes each) per student, supplemental recorded instruction materials, digital curriculum resources, and portfolio development guidance for ages 7-14.',
          'academy-2-annual': 'Full-year part-time photography tutoring services provided by credentialed instructors. Educational instruction includes composition, lighting techniques, camera operation, and creative skill development. Program includes 8 individual tutoring sessions per month (30 minutes each) per student, supplemental recorded instruction materials, digital curriculum resources, December enrichment workshops, and portfolio development guidance for ages 7-14.',
          'academy-3-monthly': 'Part-time photography tutoring services provided by credentialed instructors. Educational instruction includes composition, lighting techniques, camera operation, and creative skill development. Program includes 8 individual tutoring sessions per month (30 minutes each) per student, supplemental recorded instruction materials, digital curriculum resources, and portfolio development guidance for ages 7-14.',
          'academy-3-annual': 'Full-year part-time photography tutoring services provided by credentialed instructors. Educational instruction includes composition, lighting techniques, camera operation, and creative skill development. Program includes 8 individual tutoring sessions per month (30 minutes each) per student, supplemental recorded instruction materials, digital curriculum resources, December enrichment workshops, and portfolio development guidance for ages 7-14.',
          'academy-4-monthly': 'Part-time photography tutoring services provided by credentialed instructors. Educational instruction includes composition, lighting techniques, camera operation, and creative skill development. Program includes 8 individual tutoring sessions per month (30 minutes each) per student, supplemental recorded instruction materials, digital curriculum resources, and portfolio development guidance for ages 7-14.',
          'academy-4-annual': 'Full-year part-time photography tutoring services provided by credentialed instructors. Educational instruction includes composition, lighting techniques, camera operation, and creative skill development. Program includes 8 individual tutoring sessions per month (30 minutes each) per student, supplemental recorded instruction materials, digital curriculum resources, December enrichment workshops, and portfolio development guidance for ages 7-14.',
          'masterclass-coaching': 'Choice Navigator and part-time tutoring services for photography career development. Consultations on educational program selection, portfolio review and feedback, equipment guidance, brand development strategy, and business planning. Two individual coaching sessions with credentialed photography professionals providing personalized mentorship and career pathway guidance.',
          'masterclass-business': 'Comprehensive photography career training program combining part-time tutoring and Choice Navigator services. Educational instruction includes wedding, portrait, and commercial photography techniques, professional workflow development, business planning and financial management, marketing strategies, legal compliance guidance, digital tools training (AI editing), and industry best practices. Complete professional development curriculum delivered through individual instruction.'
        };
