...
<head>
    ...
    <title>Acromatico — We Help People See Differently</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; background: #000; color: #fff; overflow-x: hidden; -webkit-font-smoothing: antialiased; }
        .hero { height: 100vh; position: relative; display: flex; align-items: center; justify-content: center; overflow: hidden; }
        .hero-bg { position: absolute; inset: 0; z-index: 1; }
        .hero-bg img { width: 100%; height: 100%; object-fit: cover; filter: brightness(0.4) saturate(0.8); animation: slowZoom 20s ease-in-out infinite alternate; }
        @keyframes slowZoom { 0% { transform: scale(1); } 100% { transform: scale(1.1); } }
        .hero-overlay { position: absolute; inset: 0; background: radial-gradient(circle at 50% 50%, transparent 0%, rgba(0,0,0,0.6) 100%); z-index: 2; }
        .hero-content { position: relative; z-index: 10; text-align: center; max-width: 1200px; padding: 0 32px; opacity: 0; animation: fadeInUp 1.5s cubic-bezier(0.19, 1, 0.22, 1) 0.3s forwards; }
        @keyframes fadeInUp { from { opacity: 0; transform: translateY(40px); } to { opacity: 1; transform: translateY(0); } }
        .hero-title { font-size: clamp(48px, 10vw, 120px); font-weight: 200; letter-spacing: -0.04em; line-height: 1.1; margin-bottom: 32px; }
        .hero-subtitle { font-size: clamp(20px, 3vw, 32px); font-weight: 300; letter-spacing: -0.02em; color: rgba(255,255,255,0.9); margin-bottom: 48px; max-width: 800px; margin-left: auto; margin-right: auto; }
        .hero-cta { display: inline-block; padding: 20px 48px; background: rgba(255,255,255,0.15); backdrop-filter: blur(20px); border: 1px solid rgba(255,255,255,0.3); border-radius: 50px; font-size: 18px; font-weight: 500; color: #fff; text-decoration: none; transition: all 0.4s cubic-bezier(0.19, 1, 0.22, 1); }
        .hero-cta:hover { background: rgba(255,255,255,0.25); border-color: rgba(255,255,255,0.5); transform: translateY(-2px); box-shadow: 0 20px 40px rgba(0,0,0,0.3); }
        .services { padding: 120px 32px; background: #000; }
        .services-grid { max-width: 1400px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 32px; }
        .service-card { position: relative; height: 500px; border-radius: 24px; overflow: hidden; transition: all 0.6s cubic-bezier(0.19, 1, 0.22, 1); cursor: pointer; text-decoration: none; color: inherit; }
        .service-card:hover { transform: translateY(-12px); }
        .service-card img { width: 100%; height: 100%; object-fit: cover; filter: brightness(0.5) saturate(0.9); transition: all 0.6s cubic-bezier(0.19, 1, 0.22, 1); }
        .service-card:hover img { transform: scale(1.08); filter: brightness(0.6) saturate(1.1); }
        .service-card-overlay { position: absolute; inset: 0; background: linear-gradient(180deg, transparent 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.9) 100%); display: flex; flex-direction: column; justify-content: flex-end; padding: 48px; }
        .service-card h3 { font-size: 42px; font-weight: 300; letter-spacing: -0.02em; margin-bottom: 16px; transition: transform 0.6s cubic-bezier(0.19, 1, 0.22, 1); }
        .service-card:hover h3 { transform: translateY(-8px); }
        .service-card p { font-size: 17px; font-weight: 400; line-height: 1.6; color: rgba(255,255,255,0.85); max-width: 400px; opacity: 0; transform: translateY(20px); transition: all 0.6s cubic-bezier(0.19, 1, 0.22, 1) 0.1s; }
        .service-card:hover p { opacity: 1; transform: translateY(0); }
        .logo-watermark { position: fixed; bottom: 40px; right: 40px; max-width: 120px; opacity: 0.2; filter: brightness(0) invert(1); z-index: 1000; pointer-events: none; }
        @media (max-width: 768px) { .hero-title { font-size: 56px; } .services { padding: 80px 24px; } .services-grid { grid-template-columns: 1fr; gap: 24px; } .service-card { height: 450px; } .service-card p { opacity: 1; transform: translateY(0); } }
    </style>
</head>
<body>
    <section class="hero">
        ...
        <div class="hero-content">
            <h1 class="hero-title">We help people<br/>see differently.</h1>
            <p class="hero-subtitle">Photography. Education. Art. Brand Building.</p>
            <a href="#services" class="hero-cta">Explore Our Work</a>
        </div>
    </section>
    <section id="services" class="services">
        <div class="services-grid">
            <a href="/photography" class="service-card">
                <img src="/static/images/hero-photography-wedding.jpg" alt="Photography Services">
                <div class="service-card-overlay">
                    <h3>Photography</h3>
                    <p>We capture the moments that define your story. Weddings, portraits, and life's most important chapters.</p>
                </div>
            </a>
            <a href="/education" class="service-card">
                <img src="/static/images/hero-education-real.jpg" alt="Photography Education">
                <div class="service-card-overlay">
                    <h3>Education</h3>
                    <p>Teaching young creators ages 7-14 to see the world through a lens. Live classes, real skills, lasting confidence.</p>
                </div>
            </a>
            <a href="/prints" class="service-card">
                <img src="/static/prints/staging-aruba-divi-tree.jpg" alt="Fine Art Prints">
                <div class="service-card-overlay">
                    <h3>Art Prints</h3>
                    <p>Limited edition museum-quality prints for collectors. Transform your space with timeless photography.</p>
                </div>
            </a>
            <a href="/studio" class="service-card">
                <img src="/static/images/brand-seaside-boca-shoot.jpg" alt="Brand Building">
                <div class="service-card-overlay">
                    <h3>Brand Building</h3>
                    <p>Visual strategy and storytelling that sets you apart. We build brands people remember.</p>
                </div>
            </a>
        </div>
    </section>
    <img src="/static/acromatico-logo-transparent.png" alt="Acromatico" class="logo-watermark">
    <script>
