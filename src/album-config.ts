// Graphistudio Album Configuration Data
export const ALBUM_CONFIG = {
  sizes: [
    {
      ...
      name: '16×20"',
      dimensions: '40×50cm',
      description: 'Majestic format for grand storytelling',
      basePrice: 3200,
      popular: false
    },
    {
      ...
      name: '14×14"',
      dimensions: '35×35cm',
      description: 'Square format with dramatic presence',
      basePrice: 2800,
      popular: false
    },
    {
    ...
    },
    {
      ...
      name: '12×12"',
      dimensions: '30×30cm',
      description: 'Popular square format',
      basePrice: 2200,
      popular: true
    },
    {
      ...
      name: '9.5×13"',
      dimensions: '25×35cm',
      description: 'Compact yet elegant',
      basePrice: 1800,
      popular: false
    },
    {
      ...
      name: '8×12"',
      dimensions: '20×30cm',
      description: 'Intimate and classic',
      basePrice: 1600,
      popular: false
    },
    {
  ...
  coverTypes: [
    {
      id: 'crystal-glance',
      name: 'Crystal Glance',
      description: 'Image printed on massive 1/4" polycarbonate with crystalline edges',
      features: ['Timeless & modern', '3D effect', 'Diamond-cut beveled edges', 'Impact resistant'],
      basePrice: 800,
      popular: true,
      image: 'crystal-glance.jpg'
    },
    {
      id: 'metal',
      name: 'Metal Cover',
      description: 'Customizable metal plate in gold or silver finish',
      features: ['High customization', 'Satin or polish finish', 'Direct printing', 'Premium look'],
      basePrice: 650,
      popular: true,
      image: 'metal.jpg'
    },
    {
      id: 'metal-paint',
      name: 'Metal Paint',
      description: 'Modern elegance with clean lines and engraving',
      features: ['Contemporary design', 'Name engraving', 'Rounded edges', 'Avant-garde'],
      basePrice: 600,
      popular: false,
    ...
    },
    {
      id: 'hardback',
      name: 'Hardback Cover',
      description: 'Classic customizable cover printed on photo paper',
      features: ['Timeless classic', 'Full customization', 'Photo paper laminated', 'Pictures & graphics'],
      basePrice: 0,
      popular: false,
      image: 'hardback.jpg'
    }
  ...
  paperTypes: [
    {
      id: 'fuji-deep-matte',
      name: 'Fuji Deep Matte',
      description: 'Premium archival paper with velvety finish',
      features: ['True color reproduction', 'No glare', 'Museum quality', 'Most popular'],
      price: 0,
      popular: true
    },
    {
      ...
      description: 'Brilliant colors with high shine',
      features: ['Vibrant colors', 'High contrast', 'Classic look'],
      price: 0,
      popular: false
    },
    {
      id: 'metallic',
      name: 'Fuji Pearl Metallic',
      description: 'Pearlescent finish with subtle shimmer',
      features: ['3D depth effect', 'Unique look', 'Premium feel'],
      price: 100,
      popular: false
    }
  ],
  ...
  addons: {
    parentBooks: [
      {
        id: 'parent-8x12',
        name: 'Parent Book 8×12"',
        description: 'Flush mount copy for parents',
        price: 800,
        sizes: ['8x12', '8x8']
      },
      {
        id: 'parent-6x8',
        name: 'Parent Book 6×8"',
        description: 'Smaller flush mount copy',
        price: 600,
        sizes: ['6x8', '6x6']
      }
    ],
    ...
    pocketBooks: [
      {
        id: 'pocket-4x5',
        name: 'Pocket Book 4×5"',
        description: 'Perfect bound mini album',
        price: 150,
        sizes: ['4x5', '4x4']
      },
      {
        id: 'pocket-2.5x4',
        name: 'Pocket Book 2.5×4"',
        description: 'Ultra-compact keepsake',
        price: 100,
        sizes: ['2.5x4', '2x2.5']
      }
    ],
...
export function calculatePrice(config: any): number {
  let total = 0
  ...
  if (config.material) {
    for (const category in ALBUM_CONFIG.materials) {
      const material = ALBUM_CONFIG.materials[category as keyof typeof ALBUM_CONFIG.materials].find(
        (m: any) => m.id === config.material
      )
      if (material) {
  ...
  // Addons
  if (config.addons) {
    config.addons.forEach((addonId: string) => {
      // Search in all addon categories
